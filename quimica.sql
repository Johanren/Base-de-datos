...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-10-2021 a las 03:16:58
...
(22, 'Actividad 3', 40, 100, 1),
(32, 'Que Son lo Perocidos', 100, 10, 1);
...
INSERT INTO `personas` (`idPersonas`, `nombre`, `apellido`, `documentoIdentidad`, `numeroDocumento`, `fechaNacimiento`) VALUES
(1, 'Jogan Felipe', 'Rengifo Solarte', 'T.I', '1070586140', '2021-08-09'),
(9, 'diego Alejandro', 'Rengifo Ocaña', 'C.C', '1234567890', '2021-10-07');
...
INSERT INTO `personasrol` (`idPersonasRol`, `email`, `password`, `idPersonas`, `idRol`) VALUES
(2, 'feliperenjifoz@gmail.com', 'Johan321', 1, 1),
(4, 'diego@gmail.com', 'Diego123', 9, 2);
...
(10, 21, 'Pregunta 3'),
(11, 21, 'Pregunta 4'),
(12, 22, 'Pregunta Actividad 2.1.2'),
...
(18, 11, 'Verdadero', 'falso', 'Incorrecto'),
...
(23, 13, 'Verdadero', 'verdadero', 'Incorrecto'),
...
(73, 33, 'Verdadero', 'falso', 'Correcto');
...
(14, '2021-10-07 18:19:29', 12, 9),
(15, '2021-10-07 18:19:29', 13, 9),
(16, '2021-10-07 18:19:29', 14, 9),
(17, '2021-10-07 18:19:29', 15, 9),
(18, '2021-10-08 02:58:34', 33, 1),
(19, '2021-10-08 03:01:29', 33, 1);
...
ALTER TABLE `actividades`
  ...
  ADD UNIQUE KEY `tituloActividad` (`tituloActividad`),
...
ALTER TABLE `grado`
  ...
  ADD UNIQUE KEY `nombreGrado` (`nombreGrado`);
...
--
ALTER TABLE `actividades`
  MODIFY `idActividades` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `personas`
  MODIFY `idPersonas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `personasgrado`
--
ALTER TABLE `personasgrado`
  MODIFY `idPersonasGrado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `personasrol`
--
ALTER TABLE `personasrol`
  MODIFY `idPersonasRol` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `preguntas`
--
ALTER TABLE `preguntas`
  MODIFY `idPreguntas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `respuestas`
--
ALTER TABLE `respuestas`
  MODIFY `idRespuestas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;

--
-- AUTO_INCREMENT de la tabla `resultadosactividades`
--
ALTER TABLE `resultadosactividades`
  MODIFY `idResultadoActividad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
